...
HD_PWD='E:/class/Master of ANU/6213_Digital Systems and Microprocessors/my_6213/lab4/my_own_FSM/my_own_FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_FSM_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_FSM_top.tcl -notrace
